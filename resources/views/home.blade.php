...
@section('content')
    ...
    @if (currentPlan()->plan_name != 'Community')
        <section class="contained">
            ...
            <h1 class="myaccount">
                ...
                <!-- <span class="current-plan">Current Plan: {{ currentPlan()->plan_name }}</span> -->
            ...
            <div class="dashboard-main">
                ...
                <h2>Congradulations! Start Filtering Digital Audio.</h2>
    ...
    {  ?>
                ...
                @if (currentPlan()->plan_name == 'Freemium')
                    <h2>Save money and sign up for a <span class="high-text">subscription</span> today!</h2>
                @endif
                ...
                <div class="dashboard-buttons">
                    ...
                    @if (currentPlan()->subscription == 0)
                        <a href="{{ route('subscription') }}"><button>Select Subscription</button></a><br>
                    @endif

                    <a href="{{ route('my_account') }}"> <button>Go to My Account</button></a>
            ...
            <div class="subs-content">
                ...
                @foreach ($subscriptions as $key => $data)
                    ...
                    <div class="single-subs {{ $selectedClass }}">
                        ...
                        @if (!currentPlan()->subscription && $data->name == 'Community')
                            <button class="bottom-btn">

                                Selected

                            </button>
                        @elseif(currentPlan()->subscription && currentPlan()->plan_name == $data->name)
                            <button class="bottom-btn">
