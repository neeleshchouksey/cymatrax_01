                    ...
                    <?php if($item->cleaned == 0): ?>
                        <div class="card" style="margin-bottom:1%;">
                            <div class="card-body">
                                ...
                                <a class="btn btn-success" href="<?php echo e(asset('public/upload/'.$item->file_name)); ?>"
                                   download>Download</a>
                                ...
                                <div class="card" style="display:none;">
                                    <div class="card-body">
                                        <p id="demo"></p>
                                        <audio style="display:none;" id="audio<?php echo e($key); ?>" controls=""
                                ...
                                <div class="content" style="display:inline-flex;">
                                    ...
                                    <form method="post" action="<?php echo e(route('payment')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="totalduration" value="" id="duration_in_sec<?php echo e($key); ?>"
                                               class="durValue"/>


                                        <input type="hidden" name="totalcost" value="singlefile">
                                        <input type="hidden" name="fileids" value="<?php echo e($item->id); ?>"
                                               id="paypal_audio_ids"/>
                                        <input type="submit" value="Pay & Checkout" class="btn btn-warning"
                                               name="submit"/>
                                    </form>
                    ...
                    <?php else: ?>
                        ...
                        <div class="card" style="margin-bottom:1%;">
                            <div class="card-body">
                                ...
                                <p> <?php echo e(Carbon\Carbon::parse($item->created_at)->format('d-m-Y, H: i: s')); ?></p>
                                <audio controls="" style="vertical-align: middle"
                                       src="<?php echo e(asset('public/upload/'.$item->processed_file)); ?>" type="audio/mp3"
                                       controlslist="nodownload">
                                    Your browser does not support the audio element.
                                </audio>
                                <a class="btn btn-success" href="<?php echo e(asset('public/upload/'.$item->processed_file)); ?>"
                                   download>Download</a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/cymatrax_waves/resources/views/displayprofile.blade.php ENDPATH**/ ?>