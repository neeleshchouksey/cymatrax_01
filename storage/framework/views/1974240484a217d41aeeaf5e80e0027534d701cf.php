            ...
            <div class="relative">
                ...
                <?php $__currentLoopData = $getData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card" style="display:none;">
                        <div class="card-body">
                            <audio id="audio<?php echo e($key); ?>" controls=""
                            ...
                            <button style="visibility:hidden;" type="button" onclick="getDuration(<?php echo e($key); ?>)"
                ...
                <form class="checkoutform" method="POST" class="register"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="email" type="email" name="email" required="required"
                                       autocomplete="on"
                                       maxlength="40" placeholder="Email" value="<?php echo e($user->email); ?>"/>
                            </td>
                        </tr>
                        <?php
                        $fname = "";
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="first-name" type="text" name="first-name"
                                       placeholder="First Name" value="<?php echo e($fname); ?>"
                                       required="required"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input id="last-name" type="text" name="last-name"
                                       placeholder="Last Name" value="<?php echo e($lname); ?>"
                                       required="required"/>
                        ...
                        <tr>
                            <td>
                                <!-- file data pass -->
                                <input type="hidden" id="checkout_id" name="checkout_id" value="<?php echo e(Request::segment(2)); ?>">
                                <input type="hidden" id="fileids" name="fileids" value="<?php echo e($audioids); ?>" id="paypal_audio_ids"/>
                                <input type="hidden" name="totalduration" value="" id="paypal_total_duration"/>
                                <!-- file data pass -->
                                <button id="input-button" name="submit" type="button"  onclick="window.location='<?php echo e(URL::to('/')); ?>/account'" class="c-btn">Cancel</button>
                            </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/cymatrax_waves/resources/views/checkout.blade.php ENDPATH**/ ?>