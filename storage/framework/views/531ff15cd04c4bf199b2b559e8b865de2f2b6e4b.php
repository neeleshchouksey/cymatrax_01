...
<div class="content" style="display:inline-flex;margin-left: 58%;">
                  ...
                  <span style="margin-left:1%;"><a href="<?php echo e(URL::to('/account')); ?>" class="btn btn-success">Cancel</a></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/cymatrax_waves/resources/views/propaypal.blade.php ENDPATH**/ ?>